...
import EducationSVG from '../svgs/education.svg';
import ExperienceSVG from '../svgs/experience.svg';
import SkillsSVG from '../svgs/skills.svg';
  ...
  Skills: {
    ...
    data: [
      ...
      },
      {
        ...
        subtitle: "",
        content: "ArcMap • AWS • CodeIgniter • Docker • Docker Compose • Express.js • Firebase • Gatsby.js • Git • GitHub Pages • Heroku • HTML5/CSS3 • Jupyter Notebook • Laravel • LaTeX • Material-UI • Netlify • Next.js • NumPy • OpenCV • PyTorch • React • React Native • Redux • scikit-learn • styled-components • Unity • Vercel",
      },
      {
        date: "",
